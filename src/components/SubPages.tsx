  ...
  useEffect(() => {
    ...
    if (catParam) {
      const mapping: { [key: string]: string } = {
        ...
        "mrs-india": "Forever Mrs India",
        "miss-teen-india": "Forever Miss Teen India",
        "mr-india": "Forever Mr India",
        "mrs-world": "Forever Mrs World",
        "fashion-week": "Forever Fashion Week",
